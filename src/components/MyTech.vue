...
<template>
    <div id="skills">
        ...
        <div id="icons-list">
            ...
            <div class="techno-container"><i class="techno-icon devicon-javascript-plain"></i> <br /> <span>JS</span>
            </div>
            ...
            <div class="techno-container"><i class="techno-icon devicon-vuejs-plain"></i> <br /> <span>VueJS</span>
            </div>
            <div class="techno-container"><i class="techno-icon devicon-angular-plain"></i> <br /> <span>Angular</span>
            </div>
            <div class="techno-container"><i class="techno-icon devicon-react-plain"></i> <br /> <span>React</span>
            </div>
